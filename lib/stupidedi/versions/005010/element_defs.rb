    ...
    module FiftyTen
      module ElementDefs
        ...
        E1205 = t::ID.new(:E1205, "Insurance Line Code"                  , 2, 3,
          s::CodeList.build(
            "AC"  => "Optional AD&D - Child AD&D",
            "AG"  => "Preventative Care/Wellness",
            "AH"  => "24 Hour Care",
            "AJ"  => "Medicare Risk",
            "AK"  => "Mental Health",
            "AM"  => "Optional AD&D - Employee AD&D",
            "AS"  => "Optional AD&D - Spouse AD&D",
            ...
            "LC"  => "Optional Life - Child Life",
            "LIF" => "Life",
            "LM"  => "Optional Life - Employee Life",
            "LS"  => "Optional Life - Spouse Life",
            "LTC" => "Long-Term Care",
